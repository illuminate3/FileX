...
@section('styles')
	<link rel="stylesheet" type="text/css" href="{{ asset('assets/vendors/jquery.fine-uploader/fine-uploader-new.min.css') }}">
    <style>
        #trigger-upload {
            color: white;
...
@section('scripts')
	<script src="{{ asset('assets/vendors/jquery.fine-uploader/jquery.fine-uploader.min.js') }}"></script>
@stop
